...
internal static class AnsiConsolePrintExtensions
{
    ...
    internal static CustomComposer AddServiceConfig(this CustomComposer composer, ServiceConfig service)
    {
        composer.Text("CurrentName:", NameLength).Style(SpecialValueColor, service.CurrentName).LineBreak()
            ...
            .Style(ValueColor, service.EnvFiles is null ? Null : string.Join("; ", service.EnvFiles.Value.AsArray())).LineBreak()
            ...
            .Style(ValueColor, service.Links is null ? Null : string.Join("; ", service.Links.Value.AsArray())).LineBreak()
            ...
            .Style(ValueColor, service.Dns is null ? Null : string.Join("; ", service.Dns.Value.AsArray())).LineBreak()
            ...
            .Style(ValueColor, service.Command is null ? Null : string.Join(" ", service.Command.Value.AsArray())).LineBreak()
            .Style(LabelColor, "Labels:", NameLength).AddConfigLabels(service.Labels)
            .Style(LabelColor, "Expose:", NameLength)
            .Style(ValueColor, service.Expose is null ? Null : string.Join("; ", service.Expose.Value.AsArray())).LineBreak()
            .Style(LabelColor, "InitCliOptions:", NameLength)
            .Style(ValueColor, service.InitCliOptions is null ? Null : string.Join(" ", service.InitCliOptions.Value.AsArray())).LineBreak()
            .Style(LabelColor, "DockerCliOptions:", NameLength)
            .Style(ValueColor, service.DockerCliOptions is null ? Null : string.Join(" ", service.DockerCliOptions.Value.AsArray())).LineBreak()
            .Style(LabelColor, "PodmanCliOptions:", NameLength)
            .Style(ValueColor, service.PodmanCliOptions is null ? Null : string.Join(" ", service.PodmanCliOptions.Value.AsArray())).LineBreak();
        return composer;
    }
